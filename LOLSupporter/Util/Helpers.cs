            ...
            Task.Factory.StartNew(() =>
            {
                try
                {
                    using (var c = new WebClient())
                    {
                        var rawVersion =
                            c.DownloadString(
                                "https://raw.githubusercontent.com/zSakuraEvilz/LOLSupporter/master/LOLSupporter/Properties/AssemblyInfo.cs");
                        var match =
                        ...
                        if (match.Success)
                        {
                            ...
                            if (gitVersion.CompareTo(Program.Version)>0)
                            {
